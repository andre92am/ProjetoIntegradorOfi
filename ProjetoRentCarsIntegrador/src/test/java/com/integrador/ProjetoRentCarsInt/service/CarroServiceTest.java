...
class CarroServiceTest {
    ...
    void doBefore(){
        ...
        carroTeste = new Carro("Corsa","Chevrolet","Preto","Rua teste","São Paulo","Primeira descricao","Segunda Descricao","terceira descricao", 5,"sim","manual", 4,"sim", 5,"nota");
    ...
    void listarCarros() {
        ...
        Carro carroTeste2 = new Carro("Palio","FIAT","Rosa","Rua teste2","Rio de Janeiro","Primeira descricao","Segunda Descricao","terceira descricao", 5,"sim","manual", 4,"sim", 5,"nota");
